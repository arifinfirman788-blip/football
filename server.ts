...
app.post("/api/player-profile", async (req, res) => {
  ...
  try {
    ...
    const fallbackProfile = {
      ...
      number: typeof player.number === "number" && player.number > 0 ? player.number : undefined,
  ...
  "profileSources": [
    ...
    try {
      ...
      const profile = {
        ...
        number: typeof player.number === "number" && player.number > 0 ? player.number : fallbackProfile.number,
        teamName: team.name,
